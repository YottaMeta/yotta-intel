#!/usr/bin/env node
/**
 * @yottameta/yotta-intel cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-intel --agent <name>
 *   npx -y @yottameta/yotta-intel --dir <path>
 *   npx -y @yottameta/yotta-intel -g
 *   npx -y @yottameta/yotta-intel
 *   npx -y @yottameta/yotta-intel --list
 */
'use strict';
...
function usage() {
  console.log('yotta-intel installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-intel --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-intel --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-intel -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-intel                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-intel --list           List supported agent directories');
  console.log('');
  console.log('Options:');
